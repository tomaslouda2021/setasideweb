...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative pt-32 pb-20 overflow-hidden">
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-cyan-200 rounded-full blur-3xl opacity-20 animate-pulse" />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            SetAside intercepts your paycheck and locks away bill money in a protected wallet. 
          ...
          >
            {trustIndicators.map((indicator, index) => (
              <div key={index} className="flex items-center gap-2 text-slate-600">
                <div className="text-emerald-600">{indicator.icon}</div>
          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl p-8 md:p-12">
              <div className="flex items-center justify-between">
                ...
                <div className="mx-8">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-full flex items-center justify-center animate-pulse">
                    <DollarSign className="text-white" size={32} />
                  </div>
                </div>
                <div className="flex-1">
                  <div className="h-4 bg-emerald-200 rounded w-3/4 mb-4" />
